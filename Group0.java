...
public class Group0 {
	...
	private static class SortingCompetitionComparator implements Comparator<String> {
		...
		private int compareFractions(String fraction1, String fraction2) {
			...
			return numerator1.compareTo(numerator2); // note: the numerator may be negative, that would reverse the
														// ordering for negatives
		}
	...
	private static void runTests() {
		...
		System.out.println("-4.9999999999999999999999999999999999 and -5:"
				+ comp.compareDecimals("-4.9999999999999999999999999999999999", "-5"));
		System.out.println("4.9999999999999999999999999999999999 and 5:"
				+ comp.compareDecimals("4.9999999999999999999999999999999999", "5"));
